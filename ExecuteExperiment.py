...
output_directry = '/Users/PengPeng/Desktop/'
...
def executeExp():
    ...
    p8peng_out = PrefMutationRandom.MutationRandom("/Users/PengPeng/git/mutation-tolerance-voting/prefrences/sushi3_preflib/ED-00015-00000001.soc").GetResult(0.1, 0, output_directry)
    noisyPP = PrefPlotter(p8peng_out, True)    
    compute_noisy_results(noisyPP, path_leaf(p8peng_out))
    
    print('WORKING ON 0.2')
    p8peng_out = PrefMutationRandom.MutationRandom("/Users/PengPeng/git/mutation-tolerance-voting/prefrences/sushi3_preflib/ED-00015-00000001.soc").GetResult(0.2, 0, output_directry)
    noisyPP = PrefPlotter(p8peng_out, True)    
    compute_noisy_results(noisyPP, path_leaf(p8peng_out))
    
    print('WORKING ON 0.3')
    p8peng_out = PrefMutationRandom.MutationRandom("/Users/PengPeng/git/mutation-tolerance-voting/prefrences/sushi3_preflib/ED-00015-00000001.soc").GetResult(0.3, 0, output_directry)
    noisyPP = PrefPlotter(p8peng_out, True)    
    compute_noisy_results(noisyPP, path_leaf(p8peng_out))
    
    print('WORKING ON 0.4')
    p8peng_out = PrefMutationRandom.MutationRandom("/Users/PengPeng/git/mutation-tolerance-voting/prefrences/sushi3_preflib/ED-00015-00000001.soc").GetResult(0.4, 0, output_directry)
    noisyPP = PrefPlotter(p8peng_out, True)    
    compute_noisy_results(noisyPP, path_leaf(p8peng_out))
    
    print('WORKING ON 0.5')
    p8peng_out = PrefMutationRandom.MutationRandom("/Users/PengPeng/git/mutation-tolerance-voting/prefrences/sushi3_preflib/ED-00015-00000001.soc").GetResult(0.5, 0, output_directry)
    noisyPP = PrefPlotter(p8peng_out, True)    
    compute_noisy_results(noisyPP, path_leaf(p8peng_out))
